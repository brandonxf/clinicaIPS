    ...
    def load(self):
        ...
        for _, row in self.df.iterrows():
            paciente = Paciente(
                ...
                presion_sistolica=int(row['presion_sistolica']) if pd.notna(row.get('presion_sistolica')) else None,
                presion_diastolica=int(row['presion_diastolica']) if pd.notna(row.get('presion_diastolica')) else None,
                frecuencia_cardiaca=int(row['frecuencia_cardiaca']) if pd.notna(row.get('frecuencia_cardiaca')) else None,
